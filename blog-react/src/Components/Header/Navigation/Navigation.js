...
function Navigation(props) {
    ...
    const logoutClickedHandler = event => {
    ...
    return (
        ...
        <ul className={classes.Navigation}>
            ...
            <NavigationItem to={routes.ARTICLES}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            {props.user ?
                <NavigationItem to={routes.MY_ARTICLES}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            ...
            {props.user ?
                <button className={classes.logout} onClick={(e) => logoutClickedHandler(e)}>
                    Déconnexion
                </button>
                :
                null}
